...
export default function Achievements() {
  ...
  // Data Achievement diurutkan dari yang terbaru (Februari 2026 -> Agustus 2025)
  const achievementList = [
    ...
    },
    {
      ...
      image: "/AISEEF_Preview.png",
    },
    {
      title: "Finalist UI/UX",
      provider: "FasilkomFest (UPN Jatim)",
      date: "29 November 2025",
      image: "/FasilkomFest_Finalist.png",
    },
    {
      title: "Peserta UI/UX",
      provider: "FasilkomFest (UPN Jatim)",
      date: "29 November 2025",
      image: "/FasilkomFest_Peserta.png",
    },
    {
      title: "Certificate of Author",
      provider: "10th ICCSCI",
      date: "01 Agustus 2025",
      image: "/ICCSCI_Authors.jpg",
    },
    {
      title: "Certificate of Oral Presentation",
      provider: "10th ICCSCI",
      date: "01 Agustus 2025",
      image: "/ICCSCI_OralPresentation.jpg",
    },
  ];
    ...
    <main className="min-h-screen bg-white dark:bg-[#0a0a0a] pt-32 pb-20 px-6 transition-colors">
      ...
      >
        <motion.div variants={itemVariants} className="mb-16">
          <h1 className="text-5xl md:text-6xl font-extrabold mb-4 tracking-tighter italic">
            Pencapaian <span className="text-blue-600">&</span> Penghargaan.
          </h1>
          <p className="text-gray-500 dark:text-gray-400 text-lg max-w-2xl">
            Kumpulan sertifikasi, kompetisi, dan pengakuan akademik yang telah saya raih sepanjang perjalanan studi dan karier profesional.
          </p>
        </motion.div>
              ...
              <Card className="group h-full flex flex-col justify-between border-none bg-gray-50 dark:bg-neutral-900/50 hover:bg-white dark:hover:bg-neutral-800 transition-all border border-transparent hover:border-blue-600/30 shadow-sm hover:shadow-xl hover:shadow-blue-500/10 rounded-[2rem] p-8">
                <div>
                  <div className="flex justify-between items-start mb-4">
                    <div className="p-3 bg-blue-100 dark:bg-blue-600/20 text-blue-600 rounded-2xl">
                      <Award size={24} />
                    </div>
                    <span className="text-[10px] font-bold uppercase tracking-widest text-gray-400 bg-gray-200/50 dark:bg-white/5 px-3 py-1 rounded-full">
                      {ach.date.split(" ").pop()}
                    </span>
                  </div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 font-medium text-sm mb-6 flex items-center gap-2">
                    <ExternalLink size={14} className="text-blue-600" /> {ach.provider}
                  </p>
                </div>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-white/5">
                  <div className="flex items-center gap-2 text-gray-400">
                    <Calendar size={14} />
                    <span className="text-xs font-medium">{ach.date}</span>
                  </div>
                  <button
        ...
        {selectedCert && (
          <>
            <motion.div
              ...
              className="fixed inset-0 bg-black/80 backdrop-blur-xl z-[150] cursor-zoom-out"
            />
            <motion.div
              ...
              <div className="relative w-full max-w-4xl bg-white dark:bg-neutral-900 rounded-t-[2.5rem] rounded-b-none overflow-hidden shadow-2xl pointer-events-auto border border-gray-200 dark:border-white/10">
                ...
                <div className="p-6 md:px-10 flex justify-between items-center border-b dark:border-white/5 bg-white dark:bg-neutral-900">
                  <div>
                    ...
                    <p className="text-sm text-blue-600 font-medium">{selectedCert.provider}</p>
                  </div>
                  <button 
                    onClick={() => setSelectedCert(null)}
